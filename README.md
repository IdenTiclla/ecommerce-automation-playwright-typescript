...
- On pushes to `master`, the latest Allure report is published to GitHub Pages and replaces the previous one. The workflow Summary shows a pie chart of the results; Allure history is intentionally not retained in this practice project.
